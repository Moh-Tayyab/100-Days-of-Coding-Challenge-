...
function make_greet(magicians: string[]) {
    const greatMagicians = magicians.slice(); // Create a copy of the original array
...
const originalMagicians = ["Ali", "Fahad", "Sameer"];
const greatMagicians = make_greet(originalMagicians);
